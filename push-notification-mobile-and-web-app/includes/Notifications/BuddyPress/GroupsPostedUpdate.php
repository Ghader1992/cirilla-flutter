 ...
 */
class GroupsPostedUpdate extends Notification {
	...
	public function __construct() {
		$this->name  = $this->trans( 'Activity Groups Posted Update' );
		$this->group = 'buddypress';
		$this->type  = 'bp_activity_groups_posted_update';
