...
class RequestHelper {
  ...
  Future<Map<String, dynamic>> getSettings({Map<String, dynamic>? queryParameters, CancelToken? cancelToken, CachePolicy? cachePolicy}) async {
    try {
      final res = await _dioClient.get(
        Endpoints.getSettings,
        queryParameters: queryParameters,
        cancelToken: cancelToken,
        options: cacheOptions.copyWith(policy: cachePolicy ?? CachePolicy.request).toOptions(),
      );
  ...
  Future<dynamic> getProductCategories({Map<String, dynamic>? queryParameters, CancelToken? cancelToken}) async {
    try {
      final data = await _dioClient.get(
        ...
        queryParameters: queryParameters,
        cancelToken: cancelToken,
        options: cacheOptions.copyWith(policy: CachePolicy.request).toOptions(),
      );
      return data;
    } on DioException {
      rethrow;
  ...
  /// get bookable day for resources
  Future<List<Map<String, dynamic>>> getBookableDaysResources({
    Map<String, dynamic>? queryParameters,
    required String endPoint,
  }) async {
    try {
  ...
  /// Get list media
  Future<List<MediaModel>?> getListMedia({
    Map<String, dynamic>? queryParameters,
    CancelToken? cancelToken,
    dynamic data,
  }) async {
    try {
      ...
      List<MediaModel>? medias = <MediaModel>[];
      medias = res.map((value) => MediaModel.fromJson(value)).toList().cast<MediaModel>();
      return medias;
    } on DioException {
      rethrow;
    }
  ...
  Future<List<MessageData>?> getListNotify({Map<String, dynamic>? queryParameters, String? userId}) async {
    try {
      final data = await _dioClient.get(
        '${Endpoints.getNotify}/notifications?user_id=$userId&app-builder-decode=true',
        queryParameters: queryParameters,
      );
  ...
  /// Checkout
  Future<dynamic> checkout({Map<String, dynamic>? queryParameters, dynamic data, Map<String, dynamic>? header}) async {
    try {
      final res = await _dioClient.post(
          Endpoints.checkout,
          queryParameters: queryParameters,
  ...
  Future<OrderData> updateOrderUtm({
    Map<String, dynamic>? queryParameters,
    int? orderId,
    dynamic data,
  }) async {
    try {
      final ref = await _dioClient.put(
        "${Endpoints.getOrders}/$orderId",
        queryParameters: queryParameters,
        data: data,
      );
      OrderData result = OrderData.fromJson(ref);
      return result;
    } on DioException {
      rethrow;
    }
  ...
  /// Add store review
  Future<Map<String, dynamic>> writeStoresReview({Map<String, dynamic>? queryParameters, dynamic data}) async {
    try {
      final res = await _dioClient.post(Endpoints.writeStoresReview, data: data, queryParameters: queryParameters);
  ...
  /// Store review form
  Future<List<VendorReviewField>> storesReviewForm() async {
    try {
      final data = await _dioClient.get('${Endpoints.writeStoresReview}/form');

      List<VendorReviewField> value = [];
      if (data is Map) {
        value = data.values.map((item) => VendorReviewField.fromJson(item as Map<String, dynamic>)).toList();
      }
  ...
  /// Get store review
  Future<List<VendorReview>?> getStoreReviews({Map<String, dynamic>? queryParameters}) async {
    try {
      final data = await _dioClient.get(
        Endpoints.writeStoresReview,
        queryParameters: queryParameters,
      );
      List<VendorReview>? reviews = <VendorReview>[];
      reviews = data.map((review) => VendorReview.fromJson(review)).toList().cast<VendorReview>();
      return reviews;
    } on DioException {
      rethrow;
    }
  ...
  Future<Map<String, dynamic>> applyPointDiscount({
    ...
    try {
      final res = await _dioClient.post(
        '${Endpoints.applyPoint}?cart_key=$cartKey&app-builder-decode=true',
        data: data,
        cancelToken: cancelToken,
        options: Options(
          headers: {
  ...
  /// Get point reward
  Future<PointReward> getPointReward({
    Map<String, dynamic>? queryParameters,
    CancelToken? cancelToken,
    Map<String, dynamic>? header,
  }) async {
  ...
  /// Get coupon referral
  Future<CouponReferralData> getCouponReferrals({
    Map<String, dynamic>? queryParameters,
    int? userId,
  }) async {
    try {
      final res = await _dioClient.get(
        '${Endpoints.getReferrals}/$userId',
        queryParameters: queryParameters,
      );
      return CouponReferralData.fromJson(res);
    } catch (_) {
      rethrow;
    }
  }

  Future<void> referralignup({
    Map<String, dynamic>? queryParameters,
  }) async {
    try {
      await _dioClient.post(
        Endpoints.referralSignup,
        queryParameters: queryParameters,
      );
    } catch (_) {
      rethrow;
  ...
  Future<Map<String,dynamic>> enableReferralSignup({
    Map<String, dynamic>? queryParameters,
  }) async {
    try {
      final res = await _dioClient.get(
        Endpoints.enableReferralSignup,
      );
      return res;
    } catch (_) {
      rethrow;
  ...
  Future<List<ShippingZones>> getShippingZones({
    Map<String, dynamic>? queryParameters,
  }) async {
    try {
      final data = await _dioClient.get(
        Endpoints.shippingZones,
        queryParameters: queryParameters,
      );
      List<ShippingZones> zones = <ShippingZones>[];
      zones = data.map((zone) => ShippingZones.fromJson(zone)).toList().cast<ShippingZones>();
      return zones;
    } on DioException {
      rethrow;
    } catch (e) {
  ...
  Future<List<ShippingZonesMethod>> getShippingZonesMethods({
    Map<String, dynamic>? queryParameters,
    required int idZone,
  }) async {
    try {
      final data = await _dioClient.get(
        "${Endpoints.shippingZones}/$idZone/methods",
        queryParameters: queryParameters,
      );
      List<ShippingZonesMethod> methods = <ShippingZonesMethod>[];
      methods = data.map((method) => ShippingZonesMethod.fromJson(method)).toList().cast<ShippingZonesMethod>();
      return methods;
    } on DioException {
      rethrow;
    } catch (e) {
