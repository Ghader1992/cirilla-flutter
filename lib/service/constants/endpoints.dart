...
class Endpoints {
  ...
  static const String appBuilderKey = String.fromEnvironment('APP_BUILDER_KEY', defaultValue: acf.appBuilderKey);
  static const String appBuilderSecret = String.fromEnvironment('APP_BUILDER_SECRET', defaultValue: acf.appBuilderSecret);
  ...
  // apply point and reward discount
  ...
  static const String getNotify = "/push-notify/v1";
  ...
  /// shipping zones
  static const String shippingZones = '/wc/v3/shipping/zones';
  ...
  // write store review
  static const String writeStoresReview = "/app-builder/v1/stores/reviews";
  ...
  // Coupon Referral: ==================================================================================================
  static const String getReferrals = "/app-builder/v1/wps-crp/get-referral";
  static const String referralSignup = "/app-builder/v1/wps-crp/referral-signup";
  static const String enableReferralSignup = "/app-builder/v1/wps-crp/enable-referral-signup";
